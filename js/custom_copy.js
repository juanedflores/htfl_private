...
$('.swiper-slide').on('play', function() {
  if ($(this).hasClass('mediumVideo')) {
    ...
    // update variable to be this selected video
    // currentlyPlayingVideo = $(this);
    // console.log(currentlyPlayingVideo[0]);

    // if (currentlyPlayingVideo != null) {
    // observer.observe(currentlyPlayingVideo[0], { attributeFilter: ['style'] });
    // }
